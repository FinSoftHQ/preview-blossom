    ...
    <div>
        ...
        <div class="a4-page"
            ...
            <div v-for="(group, index) in groups"
                :key="index"
                class="mb-4">
                <div v-if="group.length > 0 && group[0] && group[0].mentors.length > 0">
                    <h3>พี่เลี้ยง</h3>
                    <table class="table-auto w-full border-collapse border border-gray-200 mb-4">
                        ...
                        <tbody>
                            <tr v-for="mentor in group[0].mentors"
                                :key="mentor">
                                <td class="border border-gray-200 px-4 py-2">{{ mentor }}</td>
                                <td class="border border-gray-200 px-4 py-2">{{ getMentorNickname(mentor) }}</td>
                                <td class="border border-gray-200 px-4 py-2">{{ getMentorAge(mentor) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
