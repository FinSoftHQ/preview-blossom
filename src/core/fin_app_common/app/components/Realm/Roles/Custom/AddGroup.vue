      ...
      <div v-for="(group, index) in groups"
        ...
        <UCard>
          <div class="flex justify-between items-center">
            <h2 class="text-md font-bold flex-grow">กลุ่มที่ {{ index + 1 }}</h2>
            <span class="text-sm text-gray-500">จำนวนคน: {{ group.length }}</span>
          </div>
          <div class="flex justify-between mt-3">
            <UButton @click="() => addToGroup(index)"> + เพิ่ม</UButton>
            <div class="flex justify-between w-full">
              <USelect v-model="groupMentors[index][0]" :options="availableMentors(index, 0)" placeholder="เลือกพี่เลี้ยง 1" class="w-1/3" />
              <USelect v-model="groupMentors[index][1]" :options="availableMentors(index, 1)" placeholder="เลือกพี่เลี้ยง 2" class="w-1/3 mx-2" />
              <USelect v-model="groupMentors[index][2]" :options="availableMentors(index, 2)" placeholder="เลือกพี่เลี้ยง 3" class="w-1/3" />
            </div>
          </div>
...
const member2 = ref<Person[]>([
  { id: '1', sex: 'นาง', name: 'ธรรมภณ', Lname: ' จุลพัฒน์', phone: '0699593636', position: '', group: '1', sector: 'น.1', coordinator: 'นางมณี ใจงาม', age: '23' },
  { id: '2', sex: 'นาย', name: 'ฐิติกร', Lname: ' ศิริธารา', phone: '0983593636', position: '', group: '3', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '3', sex: 'นาย', name: 'ณัฏฐกานต์', Lname: ' สุวรรณ', phone: '0883593636', position: '', group: '3', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '4', sex: 'นาย', name: 'ปัถย์', Lname: ' ปานประกอบ', phone: '0968593636', position: '', group: '4', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '5', sex: 'นาง', name: 'โสรัตน์ ', Lname: ' วัฒนศักดิ์', phone: '0683593636', position: '', group: '1', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '6', sex: 'นาง', name: 'ภาสกร', Lname: ' เกษมทรัพย์', phone: '0683593636', position: '', group: '2', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '7', sex: 'นาย', name: 'ปิติภูมิ', Lname: ' ศิริภาพันธ์', phone: '0683593636', position: '', group: '4', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '8', sex: 'นาง', name: 'ภาสกร', Lname: ' เกษมทรัพย์', phone: '0936593636', position: '', group: '2', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '10', sex: 'นาง', name: 'ปิติภูมิ', Lname: ' ศิริภาพันธ์', phone: '0869593636', position: '', group: '1', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '23' },
  { id: '11', sex: 'นาย', name: 'กิตติพงษ์', Lname: ' วงศ์', phone: '0812345678', position: '', group: '3', sector: 'น.2', coordinator: 'นายฉัตรธร ตรีวุฒิ', age: '25' },
  { id: '12', sex: 'นาง', name: 'จิราภรณ์', Lname: ' ศรีสวัสดิ์', phone: '0823456789', position: '', group: '2', sector: 'น.3', coordinator: 'นายชยา ชัยเจริญ', age: '30' },
  { id: '13', sex: 'นาย', name: 'ณัฐพล', Lname: ' ทองดี', phone: '0834567890', position: '', group: '4', sector: 'น.4', coordinator: 'นางนภัสสร รุ่งทิพย์', age: '28' },
  { id: '14', sex: 'นาง', name: 'ธนพร', Lname: ' แซ่ลี้', phone: '0845678901', position: '', group: '1', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '22' },
  { id: '15', sex: 'นาย', name: 'ปริญญา', Lname: ' ศรีสุข', phone: '0856789012', position: '', group: '3', sector: 'น.2', coordinator: 'นายฉัตรธร ตรีวุฒิ', age: '27' },
  { id: '16', sex: 'นาง', name: 'พัชรินทร์', Lname: ' วัฒนชัย', phone: '0867890123', position: '', group: '2', sector: 'น.3', coordinator: 'นายชยา ชัยเจริญ', age: '29' },
  { id: '17', sex: 'นาย', name: 'ภูมิพัฒน์', Lname: ' แก้วมณี', phone: '0878901234', position: '', group: '3', sector: 'น.4', coordinator: 'นางนภัสสร รุ่งทิพย์', age: '26' },
  { id: '18', sex: 'นาง', name: 'มณีรัตน์', Lname: ' ศรีทอง', phone: '0889012345', position: '', group: '1', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '24' },
  { id: '19', sex: 'นาย', name: 'วรพล', Lname: ' จันทร์เพ็ญ', phone: '0890123456', position: '', group: '3', sector: 'น.2', coordinator: 'นายฉัตรธร ตรีวุฒิ', age: '31' },
  { id: '20', sex: 'นาง', name: 'ศิริพร', Lname: ' ทองคำ', phone: '0901234567', position: '', group: '2', sector: 'น.3', coordinator: 'นายชยา ชัยเจริญ', age: '32' },
  { id: '21', sex: 'นาย', name: 'สมชาย', Lname: ' แซ่ตั้ง', phone: '0912345678', position: '', group: '4', sector: 'น.4', coordinator: 'นางนภัสสร รุ่งทิพย์', age: '33' },
  { id: '22', sex: 'นาง', name: 'อรทัย', Lname: ' ศรีสมบัติ', phone: '0923456789', position: '', group: '2', sector: 'น.1', coordinator: 'นางนรีรัตน์ ศรีสดุดี', age: '34' },
  { id: '23', sex: 'นาย', name: 'อาทิตย์', Lname: ' วงศ์วาน', phone: '0934567890', position: '', group: '3', sector: 'น.2', coordinator: 'นายฉัตรธร ตรีวุฒิ', age: '35' },
  { id: '24', sex: 'นาง', name: 'อารีย์', Lname: ' ศรีสวัสดิ์', phone: '0945678901', position: '', group: '1', sector: 'น.3', coordinator: 'นายชยา ชัยเจริญ', age: '36' },
  { id: '25', sex: 'นาย', name: 'อำนาจ', Lname: ' ทองดี', phone: '0956789012', position: '', group: '3', sector: 'น.4', coordinator: 'นางนภัสสร รุ่งทิพย์', age: '37' }
]);
